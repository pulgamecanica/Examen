...
user_3 = User.create(name: Faker::Zelda.character, email:Faker::Internet.email, admin: 0)
user_4 = User.create(name: Faker::Name.name, email:Faker::Internet.email, admin: 0)
user_5 = User.create(name: Faker::Zelda.character, email:Faker::Internet.email, password: "123", admin: 1)
